---
title: 将 IP 地址列入允许列表
description: 了解如何将 IP 范围添加到 Campaign 实例允许列表，以及如何使用控制面板从允许列表中将其删除。
...
控制面板允许您通过将 IP 地址范围列入允许列表来设置与实例的新连接。默认情况下，无法从各种 IP 地址访问 Adobe Campaign 实例。因此，必须将 IP 地址添加到允许列表：
...
了解如何将 IP 范围添加到 Campaign 实例允许列表，以及如何使用控制面板从允许列表中将其删除。
