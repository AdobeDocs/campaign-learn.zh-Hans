---
title: 在工作流中锁定轮廓
description: 了解活动工作流的使用、如何创建工作流以及使用筛选条件在工作流中锁定轮廓。
feauture: Profiles
jira: KT-7842
...
了解活动工作流的使用、如何创建工作流以及使用筛选条件在工作流中锁定轮廓。

>[!VIDEO](https://video.tv.adobe.com/v/3453586?captions=chi_hans&quality=12&learn=on){transcript=true}
