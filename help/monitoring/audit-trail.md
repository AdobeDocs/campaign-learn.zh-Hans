...
[!UICONTROL Audit Trail]会实时捕获在 Adobe Campaign 内发生的操作和事件的完整列表。[!UICONTROL Audit Trail] 提供一种访问数据历史记录的自助方式，可帮助回答以下问题：
...
>[!VIDEO](https://video.tv.adobe.com/v/3444244?captions=chi_hans&quality=12&learn=on){transcript=true}
