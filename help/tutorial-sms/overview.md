...
* **[针对标准 SMPP 提供商设置短信帐户](/help/tutorial-sms/set-up-account-for-standard-smpp-provider.md)**
  *了解如何根据您的 SMPP 提供商调整短信连接器。优化短信设置以处理连接限制。  理解如何设置最大吞吐量、发送窗口，以及使用 TLS 进行加密。*

* **[根据您的 SMPP 提供商调整短信连接器](/help/tutorial-sms/adapt-sms-connector-to-smpp-provider.md)**
  *了解如何优化短信设置以处理连接限制。 理解如何设置最大吞吐量、发送窗口和使用 TLS 进行加密。*

* **[SMPP 协议深入研究和疑难解答](/help/tutorial-sms/smpp-deep-dive-and-troubleshooting.md)**
